// @ts-nocheck
// rendering.ts — Frame rendering: applyFrameClip, drawClipContent, drawFilmStrip, drawFrameOverlay
import { injectSlideshowMethods } from './rendering_slideshow';
export const injectFrameRendering = () => {
    injectSlideshowMethods();
