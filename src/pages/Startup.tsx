...
import {
  UploadCloud, AlertCircle, Wand2,
  Scissors, X, ArrowLeft, Film, ImagePlay, AudioLines, MousePointer2
} from 'lucide-react';
import { useFileStore } from '../hooks/useFileStore';
import { useParticleBurst, getFileIcon, formatSize, AnimatedLogo, UserAvatar, HorizontalBadges } from './sections/startup-components';
