...
export const CMD_REFERENCE = [
  ...
  { category: '🎵 Audio', color: 'text-teal-400', icon: 'fa-music', commands: [
    ...
    { cmd: 'beatdetect', desc: 'Detect beats in audio track & add markers' },
    { cmd: 'beatsync', desc: 'Cut clips at beat markers (sync to music)' },
    { cmd: 'clearbeats', desc: 'Remove all beat markers' },
  ]},
  ...
  { category: '🤖 AI Features', color: 'text-violet-400', icon: 'fa-robot', commands: [
    ...
    { cmd: 'captions', desc: 'AI Auto Captions from audio (Arabic)' },
    { cmd: 'captions en tiktok', desc: 'AI Captions in English, TikTok style' },
    { cmd: 'captions ar youtube', desc: 'AI Captions in Arabic, YouTube style' },
  ]},
  { category: '📜 Version History', color: 'text-amber-400', icon: 'fa-clock-rotate-left', commands: [
    { cmd: 'saveversion', desc: 'Save current timeline as a snapshot' },
    { cmd: 'saveversion Before Color', desc: 'Save with a custom name' },
    { cmd: 'versions', desc: 'List all saved versions' },
    { cmd: 'restore 1', desc: 'Restore version #1' },
    { cmd: 'deleteversion all', desc: 'Delete all saved snapshots' },
  ]},
  { category: '🔤 Fonts', color: 'text-indigo-300', icon: 'fa-font', commands: [
    { cmd: 'loadfont', desc: 'Upload custom TTF/OTF/WOFF font' },
    { cmd: 'fonts', desc: 'List all loaded custom fonts' },
    { cmd: 'applyfont Cairo', desc: 'Apply font to selected text clip(s)' },
  ]},
  { category: '⏩ Speed & Reverse', color: 'text-orange-300', icon: 'fa-gauge-high', commands: [
    { cmd: 'reverse', desc: 'Toggle reverse playback on selected clip' },
    { cmd: 'speed 0.5', desc: 'Slow motion (50% speed)' },
    { cmd: 'speed 2', desc: 'Double speed (200%)' },
    { cmd: 'speedramp 0.5 2', desc: 'Speed ramp from 0.5x to 2x' },
    { cmd: 'ramp up', desc: 'Quick speed ramp up' },
    { cmd: 'ramp down', desc: 'Quick speed ramp down' },
  ]},
